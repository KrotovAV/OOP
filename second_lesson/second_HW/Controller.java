...
public class Controller {
    ...
    public static void run() throws Exception{
        ...
        String l, n, c, id, nam;
        while(check){
            View.printString(Menu.getMenuName("MaimMenu"));
            l = inS1.inputString(Menu.getMenuName("Select"));
            if(l.equals("e")) check = false;
                ...
                ArrayList<String>carstvoArrayListString = ReadWrite.readFile(Path.getPathName("pathReadCarstvo"));
                ArrayList<String>podCarstvoArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadPodCarstvo"));
                ArrayList<String>tipArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadTip"));
                ArrayList<String>klassArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadKlass"));
                ArrayList<String>podKlassArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadPodKlass"));
                ArrayList<String>otriydArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadOtriyd"));
                ArrayList<String>semeistvoArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadSemeistvo"));
                ArrayList<String>rodArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadRod"));
                ArrayList<String>vidArrayListString  = ReadWrite.readFile(Path.getPathName("pathReadVid"));
                ...
                if (l.equals("s")) {
                    while(checkS) {
                        n = inS1.inputString(Menu.getMenuName("Show"));
                        if (n.equals("e")) { checkS = false;}
                        else {
                            if (n.equals("c")) {View.printClassification(c1);}
                            else if (n.equals("pc")) {View.printClassification(c2);}
                            else if (n.equals("t")) {View.printClassification(c3);}
                            else if (n.equals("k")) {View.printClassification(c4);}
                            else if (n.equals("pk")) {View.printClassification(c5);}
                            else if (n.equals("o")) {View.printClassification(c6);}
                            else if (n.equals("s")) {View.printClassification(c7);}
                            else if (n.equals("r")) {View.printClassification(c8);}
                            else if (n.equals("v")) {View.printClassification(c9);}
                    ...
                    while(checkF) {
                        ...
                        if (n.equals("e")) { checkF = false; }
                            ...
                            if (n.equals("c")) {
                                ...
                                String pcfName = inS1.inputString(Menu.getMenuName("PodCarstvoNae"));
